...
const SearchResultVidCard = ({ video }) => {
  return (
    <Link to={`/video/${video.videoId}`}>
      <div className="flex flex-col md:flex-row mb-8 md:m-3 lg:hover:bg-white/[0.1] rounded md:p-4">
...
export default SearchResultVidCard